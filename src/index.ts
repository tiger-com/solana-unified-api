/**
 * `@tigertrade/perp-sdk` — TypeScript client for the Tiger Solana unified
 * perpetuals API.
 *
 ...
 * - `@tigertrade/perp-sdk/node` — keypair signer
 * - `@tigertrade/perp-sdk/solana` — submit and confirm transactions
 * - `@tigertrade/perp-sdk/realtime` — live execution and position events
 */

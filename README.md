...
[![npm](https://img.shields.io/npm/v/@tigertrade/perp-sdk.svg)](https://www.npmjs.com/package/@tigertrade/perp-sdk)
...
```bash
npm install @tigertrade/perp-sdk
```
...
| --- | --- | --- |
| `@tigertrade/perp-sdk` | Client, resources, types, decimal helpers | — |
| `@tigertrade/perp-sdk/node` | Keypair signer, CLI keypair reader | `tweetnacl` (injected) |
| `@tigertrade/perp-sdk/browser` | Wallet-adapter signer | — |
| `@tigertrade/perp-sdk/solana` | Submit/confirm, onboarding and revocation drivers | `@solana/web3.js` |
| `@tigertrade/perp-sdk/realtime` | Live executions and position events | bundled `centrifuge` |
...
```ts
import { walletAdapterSigner } from "@tigertrade/perp-sdk/browser";
...
```ts
import { decimal, alignQuantity, validateOrder } from "@tigertrade/perp-sdk";
...
```ts
import { subscribeEvents } from "@tigertrade/perp-sdk/realtime";
...
```ts
import { hasErrorCode } from "@tigertrade/perp-sdk";
...
the copy inside `node_modules/@tigertrade/perp-sdk/spec/`.
